...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-=&&!@b0*@(7sz3whxx^oj)h%_wprf+yzgj&ed&xid@-evd@8r4',
)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'wholesale_db'),
...
# OR for quick development testing (allows all origins)
